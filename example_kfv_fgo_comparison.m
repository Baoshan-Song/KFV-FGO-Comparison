...
%% Step1: Load config
init_settings_kfv_fgo_comparison;
...
% Plot
figure; 
scatter(data.emitter_positions(1, :), data.emitter_positions(2, :), 100, 'k', 'filled');
hold on;
plot(data.true_positions(1,:), data.true_positions(2,:), 'b.-', 'LineWidth', 1.5, 'MarkerSize', 10); 
hold on;
