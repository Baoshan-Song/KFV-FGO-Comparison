"""Sliding-window FGO on real data.

Run after installing this workspace: python examples/example_sw_fgo_real.py
"""

import argparse
from pathlib import Path

from kfv_fgo.config.settings import load_config, resource_path, workspace_root
...
def run(
    ...
    *,
    ...
    cfg = load_config(config_path or resource_path("gnss_ins_swfgo.json"))
    ...
    output = (
        ...
        else workspace_root() / "results" / "sw_fgo_real"
    )
